...
function ImageDetail(props) {
  ...
  function descargar() {
    ...
    console.log(fileUrl);
    a.setAttribute('href', 'data:application/octet-stream,' + encodeURIComponent(fileUrl));
  ...
  return (
    <div className="ImageDetail">
      {image.image ? (
        ...
        <div className="DetailRight"><HashLoader color={'#EB0105'} loading={true}  size={150} /></div>
      )}
        {image.title? 
        ...
        <a id="descargar" href={image.image.secure_url}  download="cute.jpg">descargar</a>
        </div>
